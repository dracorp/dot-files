# Generated by Powerlevel10k configuration wizard on 2021-03-03 at 23:59 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|k|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|fluxctl|stern'
  ...
  ###############################[ public_ip: public IP address ]###############################
  # Public IP color.
  typeset -g POWERLEVEL9K_PUBLIC_IP_FOREGROUND=76
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VPN_IP_INTERFACE='(VPNUWireguard|gpd|wg|(.*tun)|tailscale)[0-9]*'
